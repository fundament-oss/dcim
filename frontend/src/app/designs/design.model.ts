...
export const MOCK_DESIGNS: LogicalDesign[] = [
  { id: 'design-001', name: 'AMS-01 Compute Cluster v1', version: 1, status: 'active', created: '2025-01-15' },
  { id: 'design-002', name: 'AMS-01 Network Spine', version: 2, status: 'active', created: '2025-02-03' },
  { id: 'design-003', name: 'AMS-02 Expansion Draft', version: 1, status: 'draft', created: '2025-03-20' },
  { id: 'design-004', name: 'FRA-01 Colocation Layout', version: 1, status: 'archived', created: '2024-11-10' },
];
...
export const MOCK_LOGICAL_CONNECTIONS: LogicalConnection[] = [
  { id: 'conn-001', designId: 'design-001', sourceDeviceId: 'dev-001', sourcePortRole: 'downlink-1', targetDeviceId: 'dev-002', targetPortRole: 'uplink', connectionType: 'network' },
  { id: 'conn-002', designId: 'design-001', sourceDeviceId: 'dev-001', sourcePortRole: 'downlink-2', targetDeviceId: 'dev-003', targetPortRole: 'uplink', connectionType: 'network' },
  { id: 'conn-003', designId: 'design-001', sourceDeviceId: 'dev-002', sourcePortRole: 'server-1', targetDeviceId: 'dev-004', targetPortRole: 'nic-0', connectionType: 'network' },
  { id: 'conn-004', designId: 'design-001', sourceDeviceId: 'dev-002', sourcePortRole: 'server-2', targetDeviceId: 'dev-005', targetPortRole: 'nic-0', connectionType: 'network' },
  { id: 'conn-005', designId: 'design-001', sourceDeviceId: 'dev-003', sourcePortRole: 'server-1', targetDeviceId: 'dev-006', targetPortRole: 'nic-0', connectionType: 'network' },
  { id: 'conn-006', designId: 'design-001', sourceDeviceId: 'dev-007', sourcePortRole: 'outlet-1', targetDeviceId: 'dev-004', targetPortRole: 'psu-0', connectionType: 'power' },
  { id: 'conn-007', designId: 'design-002', sourceDeviceId: 'dev-008', sourcePortRole: 'peer', targetDeviceId: 'dev-009', targetPortRole: 'peer', connectionType: 'network' },
  { id: 'conn-008', designId: 'design-002', sourceDeviceId: 'dev-008', sourcePortRole: 'downlink-1', targetDeviceId: 'dev-010', targetPortRole: 'uplink', connectionType: 'network' },
  { id: 'conn-009', designId: 'design-002', sourceDeviceId: 'dev-012', sourcePortRole: 'inside', targetDeviceId: 'dev-010', targetPortRole: 'downlink-1', connectionType: 'network' },
];
...
export const DEVICE_ROLE_COLORS: Record<LogicalDeviceRole, { bg: string; border: string; text: string }> = {
