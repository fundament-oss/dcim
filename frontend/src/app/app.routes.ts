...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'catalog',
        loadComponent: () =>
          import('./catalog/catalog').then(m => m.default),
      },
      {
        path: 'inventory/:id',
        loadComponent: () =>
          import('./inventory/asset-detail/asset-detail').then(m => m.default),
      },
      {
        path: 'inventory',
        loadComponent: () =>
          import('./inventory/inventory').then(m => m.default),
      },
      {
        path: 'datacenters/:id',
        loadComponent: () =>
      ...
      },
      {
        path: 'datacenters',
        loadComponent: () =>
          import('./datacenters/datacenters').then(m => m.default),
      },
      {
        path: 'racks/device/:id',
        loadComponent: () =>
          import('./racks/device-detail/device-detail').then(m => m.default),
      },
      {
        path: 'racks/:rackId',
        loadComponent: () =>
          import('./racks/racks').then(m => m.default),
      },
      {
        path: 'racks',
        loadComponent: () =>
      ...
      },
      {
        path: 'patch-mapping',
        loadComponent: () =>
          import('./patch-mapping/patch-mapping').then(m => m.default),
      },
      {
      ...
      },
      {
        path: 'designs/:id',
        loadComponent: () =>
          import('./designs/design-detail/design-detail').then(m => m.default),
      },
      {
        path: 'designs',
        loadComponent: () =>
          import('./designs/designs').then(m => m.default),
      },
    ],
  },
  {
