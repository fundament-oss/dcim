...
export const DEVICE_PORTS: Record<string, Port[]> = {
  ...
  'd-001': [
    ...
    { id: 'p-001-05', deviceId: 'd-001', name: 'Te1/0/1', type: 'network-interface', label: 'Uplink 1' },
    { id: 'p-001-06', deviceId: 'd-001', name: 'Te1/0/2', type: 'network-interface', label: 'Uplink 2' },
  ...
  'd-003': [
    ...
    { id: 'p-003-03', deviceId: 'd-003', name: 'eth2', type: 'network-interface', label: 'Management' },
  ...
  'd-101': [
    ...
    { id: 'p-101-05', deviceId: 'd-101', name: 'Te0/1', type: 'network-interface', label: 'Uplink' },
  ...
  'd-301': [
    { id: 'p-301-01', deviceId: 'd-301', name: 'Et1/1', type: 'network-interface', label: 'Downlink 1' },
    { id: 'p-301-02', deviceId: 'd-301', name: 'Et1/2', type: 'network-interface', label: 'Downlink 2' },
    { id: 'p-301-03', deviceId: 'd-301', name: 'Et1/3', type: 'network-interface', label: 'Downlink 3' },
  ...
  'd-601': [
    ...
    { id: 'p-601-03', deviceId: 'd-601', name: 'Te0/1', type: 'network-interface', label: 'Uplink' },
...
export const MOCK_CABLES: Cable[] = [
  // AMS-01: server-01 → tor-switch-01 (data)
  {
    id: 'cab-001',
    dcId: 'ams-01',
    aSide: { deviceId: 'd-003', deviceName: 'server-01', portId: 'p-003-01', portName: 'eth0', portType: 'network-interface' },
    bSide: { deviceId: 'd-001', deviceName: 'tor-switch-01', portId: 'p-001-01', portName: 'Gi0/1', portType: 'network-interface' },
    type: 'cat6a', label: 'srv01-data', color: 'blue', status: 'connected',
  },
  {
    id: 'cab-002',
    dcId: 'ams-01',
    aSide: { deviceId: 'd-003', deviceName: 'server-01', portId: 'p-003-02', portName: 'eth1', portType: 'network-interface' },
    bSide: { deviceId: 'd-001', deviceName: 'tor-switch-01', portId: 'p-001-02', portName: 'Gi0/2', portType: 'network-interface' },
    type: 'cat6a', color: 'blue', status: 'connected',
  },
  // AMS-01: server-01 mgmt → patch-panel-01
  {
    id: 'cab-003',
    dcId: 'ams-01',
    aSide: { deviceId: 'd-003', deviceName: 'server-01', portId: 'p-003-03', portName: 'eth2', portType: 'network-interface' },
    bSide: { deviceId: 'd-002', deviceName: 'patch-panel-01', portId: 'p-002-03', portName: 'Port 3', portType: 'network-interface' },
    type: 'cat5e', color: 'yellow', status: 'connected', label: 'srv01-mgmt',
  ...
  // AMS-01: server-01 power
  {
    id: 'cab-004',
    dcId: 'ams-01',
    aSide: { deviceId: 'd-003', deviceName: 'server-01', portId: 'p-003-06', portName: 'PSU-A', portType: 'power-port' },
    bSide: { deviceId: 'd-008', deviceName: 'pdu-01', portId: 'p-008-03', portName: 'Outlet 3', portType: 'power-outlet' },
    type: 'power', color: 'orange', status: 'connected',
  },
  // AMS-01: tor-switch-01 → spine-switch-01 (uplinks)
  {
    id: 'cab-005',
    dcId: 'ams-01',
    aSide: { deviceId: 'd-001', deviceName: 'tor-switch-01', portId: 'p-001-05', portName: 'Te1/0/1', portType: 'network-interface' },
    bSide: { deviceId: 'd-301', deviceName: 'spine-switch-01', portId: 'p-301-01', portName: 'Et1/1', portType: 'network-interface' },
    type: 'dac', label: 'spine-uplink-1', color: 'teal', status: 'connected',
  },
  {
    id: 'cab-006',
    dcId: 'ams-01',
    aSide: { deviceId: 'd-001', deviceName: 'tor-switch-01', portId: 'p-001-06', portName: 'Te1/0/2', portType: 'network-interface' },
    bSide: { deviceId: 'd-301', deviceName: 'spine-switch-01', portId: 'p-301-02', portName: 'Et1/2', portType: 'network-interface' },
    type: 'dac', label: 'spine-uplink-2', color: 'teal', status: 'connected',
  },
  // AMS-01: leaf-switch-01 → spine-switch-01
  {
    id: 'cab-007',
    dcId: 'ams-01',
    aSide: { deviceId: 'd-101', deviceName: 'leaf-switch-01', portId: 'p-101-05', portName: 'Te0/1', portType: 'network-interface' },
    bSide: { deviceId: 'd-301', deviceName: 'spine-switch-01', portId: 'p-301-03', portName: 'Et1/3', portType: 'network-interface' },
    type: 'dac', label: 'leaf-spine-uplink', color: 'teal', status: 'connected',
  },
  // AMS-01: server-10 → leaf-switch-01
  {
    id: 'cab-008',
    dcId: 'ams-01',
    aSide: { deviceId: 'd-102', deviceName: 'server-10', portId: 'p-102-01', portName: 'eth0', portType: 'network-interface' },
    bSide: { deviceId: 'd-101', deviceName: 'leaf-switch-01', portId: 'p-101-01', portName: 'Gi0/1', portType: 'network-interface' },
    type: 'cat6a', color: 'green', status: 'connected',
  },
  // AMS-01: server-01 console (planned)
  {
    id: 'cab-009',
    dcId: 'ams-01',
    aSide: { deviceId: 'd-003', deviceName: 'server-01', portId: 'p-003-05', portName: 'COM1', portType: 'console-port' },
    bSide: { deviceId: 'd-002', deviceName: 'patch-panel-01', portId: 'p-002-01', portName: 'Port 1', portType: 'network-interface' },
    type: 'console', color: 'light-grey', status: 'planned', label: 'srv01-console',
  ...
  // AMS-01: decommissioned old link
  {
    id: 'cab-010',
    dcId: 'ams-01',
    aSide: { deviceId: 'd-001', deviceName: 'tor-switch-01', portId: 'p-001-03', portName: 'Gi0/3', portType: 'network-interface' },
    bSide: { deviceId: 'd-002', deviceName: 'patch-panel-01', portId: 'p-002-04', portName: 'Port 4', portType: 'network-interface' },
    type: 'cat6', color: 'dark-grey', status: 'decommissioned', label: 'old-srv02-uplink',
  ...
  // FRA-01: server-61 → tor-switch-01
  {
    id: 'cab-011',
    dcId: 'fra-01',
    aSide: { deviceId: 'd-603', deviceName: 'server-61', portId: 'p-603-01', portName: 'eth0', portType: 'network-interface' },
    bSide: { deviceId: 'd-601', deviceName: 'tor-switch-01', portId: 'p-601-01', portName: 'Gi0/1', portType: 'network-interface' },
    type: 'cat6a', color: 'green', status: 'connected',
  },
  // FRA-01: server-61 power (planned — no PDU yet)
  {
    id: 'cab-012',
    dcId: 'fra-01',
    aSide: { deviceId: 'd-603', deviceName: 'server-61', portId: 'p-603-04', portName: 'PSU-A', portType: 'power-port' },
    bSide: { deviceId: 'd-601', deviceName: 'tor-switch-01', portId: 'p-601-05', portName: 'PSU-A', portType: 'power-port' },
    type: 'power', color: 'orange', status: 'planned',
